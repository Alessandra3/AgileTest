...
class question_model extends CI_Model {
	...
	{
		$query = $this->db->query("select Q.text, Q.id_question, A.definition, A.count, A.value, A.id_que_ans from question as Q, question_answer as A where Q.id_question=".$question_num." and A.id_question=Q.id_question order by A.count;");
